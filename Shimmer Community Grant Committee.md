...
# Shimmer Community Grant Committee - Version 3 05/12/22
...
* We propose establishing a **Verein (Association) in Switzerland** as legal entity to operate the Grant committee in where the elected Committee members become members (Veriensmitglieder).
...
- We propose to set up a Swiss Association (Verein) for this purpose
- The Project Lead will be employed by the Verein to Lead the Grant program with the respective rights and responsibilities.
- Grant reviewers will sign Service Provider contracts with the Swiss Verein.
- Details of this are still under review, and a meeting with Swiss lawyers is scheduled to discuss this.

This setup will enable a regulated and lawful grant-giving committee that can be held accountable and operates under a transparent and regulated status. The Verein will be obligated to pay taxes and follow all regulations of Swiss law.
...
- The Verein and its members (board/Vorstand and members/Mitglieder) will be legally bound through obligations in the statutes of the Association to follow Governance decisions by the Shimmer Tokens holders so that the community will have direct control and enforcement over the Committee.

**Registration & costs**

* Founding a Verein is free in Switzerland.
* Legal costs of 8000 - 10000 CHF will occur
* The Vereins actual site (Verwaltungssitz) must be in Switzerland.
* The purpose of the Verein must be non Profit. Any profits that are established need to be used to fullfill the purpose of the Verein, A profit share to the members is not possible.
* One member of the borad needs to be a swiss citizen and live in Switzerland. For this case swiss lawyers offer a service to provide such a board member that is only a signer without enforcing powers. The costs for this servide are around 800 CHF per month.
* The Verein is founded once the founding members constsitute and establish the statutes of the Verein in a meeting and sign the statutes
* Registartion with tghe local authorities will take around 6-8 weeks.
