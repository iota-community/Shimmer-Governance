...
# Shimmer Community Grant Committee - Version 3 - 07/12/22
...
3.) Change in the approach of establishing a legal entity. As there are currently still unresolved questions of what would be the best legal setup, we do not wish to fix us now on a final setup. The committee will therefore start with legal "training wheels" provided by the Tangle Ecosystem Association. This will ensure a quick setup of the committee as a Committee integrated into the structure of TEA, operating under this framework. Once this has been established, we can make a full legal opinion and comparison, and a final decision to establish its own entity can follow later.

**If you like this proposal, please show your support by voting in this poll.**
...
* We propose establishing the committee as part of the Tangle Ecosystem Association to operate the Grant committee untill final research and decision on the best legal setup have been conducted.
...
* The Lead will be employed to lead the committee by the Verein that acts as the legal body of the Program and offers limited liability and the needed legal structure to ensure a safe operation. 
* The Lead will receive a salary of 11200 USD per month on a 40 hours per-week basis and will sign a 12 month contract. 
...
* Grant reviewers will operate on a service provider contract basis with the Verein.
* Grant reviewers will be compensated with 50 USD (net) per hour for a maximum of 40 hours per month / 10 hours per week submitted via invoice to the Swiss Verein.
...
* All committee members will do KYC to reveal and verify their identity and sign a legally binding contract (employment or service provider) with the Verein.
...
6. **The requested budget must match industry standards for comparable tasks. If a proposal requests way above fair market value, the committee will go into a dialogue with the team to request adjustments. The committee may either reject such a proposal or cut the funding to settle at fair market value.**
...
* **Tier 3: Low Tier 25.000 - 100.000 / Regular Tier 50.000 - 200.000 USD**: Same requirements as the previous tier apply. The Project Team must do KYC (3 members do KYC, including the Grant submitter and Project Team Lead, that will be the signer, 3rd Person decided by the Grant Committee Lead). Additionally, applications need approval by the entire grant committee. Projects that are considered to be approved will be invited to present the idea in an extensive live interview with two grant reviewers and the Program Lead. A minimum of three milestones are defined, and payments happen based on these milestones.
...
- We propose to start this Grant committee under the umbrella of the Tangle Ecosystem Association untill enough research and a final decision on where to establish which kind of entity has been conducted. This will likely take more time, and starting under the umbrella of the already existing Swiss Association will enable a quick establishment and give them time to finally research all the establishment options. (This is currently under review!)
- Committee Lead and Grant reviewers will sign Service Provider contracts with the Swiss Verein and receive legal liability protection from the swiss entity based on this service contract.
...
- All committee members will be legally KYC'd and known to the Verein and can be made responsible if any misbehavior occurs based on their contractual terms.
- The Committee will form a separate "Auschuss (Committee)") in TEA and operate under the rules and statutes of the specification laid out in this proposal.

**Registration & costs**

* No costs involved to establish the committee as part of TEA
* Potential costs for accounting and tax reporting would be billed by TEA to the community or by an external service provider.


**Once funds are available, we may conduct further research, including a specialized lawyer, to come to an optimal solution for the future.
...
- Finalizing the talks around the legal entity in Switzerland with drafting all documents and contracts for the Lead and Grant reviewer. 
